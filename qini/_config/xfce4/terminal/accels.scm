...
(gtk_accel_path "<Actions>/terminal-window/fullscreen" "<Alt>F11")
...
(gtk_accel_path "<Actions>/terminal-window/preferences" "<Primary><Alt>p")
...
(gtk_accel_path "<Actions>/terminal-window/show-menubar" "<Primary><Shift>m")
