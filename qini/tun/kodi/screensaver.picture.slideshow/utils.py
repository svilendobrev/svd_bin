...
CACHEFOLDER = xbmcvfs.translatePath(xbmcaddon.Addon().getAddonInfo('profile'))#.decode('utf-8')
CACHEFILE   = os.path.join(CACHEFOLDER, '%s')
RESUMEFILE  = os.path.join(CACHEFOLDER, 'offset')
ASFILE      = xbmcvfs.translatePath('special://profile/advancedsettings.xml')#.decode('utf-8')
